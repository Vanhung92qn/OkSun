...
var manifest = {
    packageUrl: 'https://res.oksun.win/remote-assets/',
    remoteManifestUrl: 'https://res.oksun.win/remote-assets/project.manifest',
    remoteVersionUrl: 'https://res.oksun.win/remote-assets/version.manifest',
    version: '1.0.0',
    assets: {},
    searchPaths: []
};
...
var urlBundle = "E:/buildapp/clienthit/client/build/web-mobile"
var dest = 'E:/buildapp/clienthit/build/web-mobile/assets';
var assetsUrl = "E:/buildapp/clienthit/build/web-mobile/assets"
var src = './jsb/';
...
fs.readdir(assetsUrl, (err, files) => {
    ...
    listVersion = [];
    files.forEach(file => {
       // console.log(path.join(assetsUrl, file));
