...
(function () {
    cc.SubdomainName = cc.Enum({
        ...
        SONTINHTHUYTINH: 'sontinhthuytinh.',
        ANKHETRAVANG: 'ankhetravang.',
        KHOTANGNGULONG: 'khotangngulong.',

        MONKEY: 'monkey.',
        XOC_XOC: 'xocdia.',
        XOC_DIA_TL: 'xocdiatl.',
        XOC_DIA_LIVESTREAM: 'xocdialivestream.',
        DRAGON_TIGER: "dragon.",
        BACCARAT: 'baccarat.',
        BAUCUA: 'baucua.',
        ...
        TAI_XIU_SIEU_TOC: "taixiusieutoc.",
        TAI_XIU_LIVESTREAM: "taixiulivestream.",
		SICBO: "sicbo.",
