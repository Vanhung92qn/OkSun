...
(function () {
    ...
    TID = 0;
    Z_INDEX = 10;
    MIN_VIP_SHOW_CHAT = 2; //rank toi thieu show VIP khi chat
    ...
    var TELE_HOTRO = 'https://t.me/cskhoksun';
    var TAI_OTP_X6 = '#';
    var LIVE_CHAT = 'https://t.me/cskhoksun';

    var DOWNLOAD_URL_B1 = netConfig.DOWNLOAD_APK_URL;
    var DOWNLOAD_URL_B2 = netConfig.DOWNLOAD_APK_URL;
    var DOWNLOAD_URL_B3 = netConfig.DOWNLOAD_APK_URL;
    var DOWNLOAD_URL_B4 = netConfig.DOWNLOAD_APK_URL;
    var DOWNLOAD_TELE = 'https://telegram.org/';
    var MD5_SERVICE = 'https://md5.services/';
    var SICBO_MD5_SERVICE = 'https://www.md5hashgenerator.com/';
    ...
    Config = (function () {
        ...
        Config.prototype.getGameName = function (gameId) {
            switch (gameId.toString()) {
                ...
                case cc.GameId.SONTINHTHUYTINH:
                    return cc.GameName.SONTINHTHUYTINH;
                case cc.GameId.ANKHETRAVANG:
                    return cc.GameName.ANKHETRAVANG;
                case cc.GameId.KHOTANGNGULONG:
                    return cc.GameName.KHOTANGNGULONG;
                case cc.GameId.DRAGON_BALL:
                ...
                case cc.GameId.TAI_XIU_LIVESTREAM:
                    return cc.GameName.TAI_XIU_LIVESTREAM;
              ...
              //  case cc.GameId.XOC_XOC_VIP:
               //     return cc.GameName.XOC_XOC_VIP;
				case cc.GameId.XOC_XOC:
                    return cc.GameName.XOC_XOC;
                case cc.GameId.XOCDIA:
                    return cc.GameName.XOC_DIA_TL;
                case cc.GameId.XOC_DIA_LIVESTREAM:
                    return cc.GameName.XOC_DIA_LIVESTREAM;
        ...
        Config.prototype.getSubDomainByHub = function (hubName) {
            switch (hubName) {
                ...
                case cc.HubName.SonTinhThuyTinhHub:
                    return cc.SubdomainName.SONTINHTHUYTINH;
                case cc.HubName.AnKheTraVangHub:
                    return cc.SubdomainName.ANKHETRAVANG;
                case cc.HubName.KhoTangNguLongHub:
                    return cc.SubdomainName.KHOTANGNGULONG;
                ...
                case cc.HubName.XocDiaTLHub:
                    return cc.SubdomainName.XOC_DIA_TL;
                case cc.HubName.XocDiaLivestreamHub:
                    return cc.SubdomainName.XOC_DIA_LIVESTREAM;
                ...
                case cc.HubName.LivestreamLuckyDiceHub:
                    return cc.SubdomainName.TAI_XIU_LIVESTREAM;
        ...
        Config.prototype.sicboMd5Service = function () {
            return SICBO_MD5_SERVICE;
        };
