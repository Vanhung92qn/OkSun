...
(function () {
    cc.BottomBarView = cc.Class({
        ...
        onLoad: function () {
            ...
            cc.tween(this.countEvent)
                    .repeatForever(
                        cc.tween().sequence(
                            cc.tween().to(0.3, { scale: 1.2 }, { easing: cc.easing.sineOut }),
                            cc.tween().to(0.3, { scale: 1.0 }, { easing: cc.easing.sineOut })))
                    .start();
        },
        ...
        eventClicked: function () {
            if (cc.LoginController.getInstance().checkLogin()) {
                cc.LobbyController.getInstance().createMissionView();
            }
        },
        ...
        hotlineClicked: function () {
			cc.PopupController.getInstance().showMessage("Đang Cập Nhật");
        //    if (cc.LoginController.getInstance().checkLogin()) {
        //        cc.LobbyController.getInstance().openHotro();
		//		
        //    }
        },
    });
