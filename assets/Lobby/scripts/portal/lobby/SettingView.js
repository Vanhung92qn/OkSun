...
(function () {
    cc.SettingView = cc.Class({
        ...
        openSetting: function () {
            this.animationSetting.play('openPopup');
            this.clickNhac();
        },

        closeSetting: function () {
            this.animationSetting.play('closePopup');
       //     this.settingmore.active = false;
            this.clickNhac();
        },
        ...
        clickHoTro: function() {
            this.settingmore.active = !this.settingmore.active;
        },
        clickNhac: function() {
            this.settingnhac.active = !this.settingnhac.active;
        },
        LiveChatHoTro: function() {
        ...
        HotlineHotro: function() {
            var clickEventHandler = new cc.Component.EventHandler();
            clickEventHandler.target = this; //This node is the node to which your event handler code component belongs
            clickEventHandler.component = 'SettingView';//This is the code file name
            clickEventHandler.handler = 'cancelLogoutClicked';
