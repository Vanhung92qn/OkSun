...
(function () {
    ...
    LobbyJackpotController = (function () {
        ...
        LobbyJackpotController.prototype.setJackpotTx = function (moneytai,moneyxiu) {
            return this.lobbyJackpotView.setJackpotTx(moneytai,moneyxiu);
        };
        LobbyJackpotController.prototype.setJackpotTxMD5 = function (moneytai,moneyxiu) {
            return this.lobbyJackpotView.setJackpotTxMD5(moneytai,moneyxiu);
        };

        LobbyJackpotController.prototype.setJackpotBauCua = function (jp) {
            console.log("hello");
            console.log(jp);
        };
