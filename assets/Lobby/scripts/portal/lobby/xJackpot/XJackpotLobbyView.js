...
(function () {
    cc.XJackpotLobbyView= cc.Class({
        ...
        properties: {
            ...
            xSonTinhThuyTinh: cc.XJackpotPinView,
            xAnKheTraVang: cc.XJackpotPinView,
            xKhoTangNguLong: cc.XJackpotPinView,
        ...
        onGetGameJackpotInfoResponse: function (response) {
            ...
            response.forEach(function (xJackpot) {
                switch (xJackpot.GameID.toString()) {
                    ...
                    case cc.GameId.SONTINHTHUYTINH:
                        sontinhthuytinhs.push(xJackpot);
                        break;
                    case cc.GameId.ANKHETRAVANG:
                        ankhetravangs.push(xJackpot);
                        break;
                    case cc.GameId.KHOTANGNGULONG:
                        khotangngulongs.push(xJackpot);
                        break;
            ...
            this.xSonTinhThuyTinh.startRun(sontinhthuytinhs);
            this.xAnKheTraVang.startRun(ankhetravangs);
            this.xKhoTangNguLong.startRun(khotangngulongs);
