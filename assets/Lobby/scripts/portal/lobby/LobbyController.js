    ...
    LobbyController = (function () {
       ...
       // };
        ...
        LobbyController.prototype.createShopView = function (startTab) {
            ...
            if (startTab === cc.ShopTab.TOPUP || startTab === cc.ShopTab.BANK || startTab === cc.ShopTab.ONEPAY || startTab === cc.ShopTab.MOMO
                || startTab === cc.ShopTab.TRANSFER || startTab === cc.ShopTab.REDEEM_REWARD) {
        ...
        LobbyController.prototype.createMissionView = function () {
            return this.lobbyView.createMissionView();
        };

        LobbyController.prototype.destroyMissionView = function () {
            return this.lobbyView.destroyMissionView();
        };
        LobbyController.prototype.createInboxView = function () {
            return this.lobbyView.createInboxView();
        };

        LobbyController.prototype.destroyInboxView = function () {
            return this.lobbyView.destroyInboxView();
        };
        LobbyController.prototype.creatSettingView = function () {
            return this.lobbyView.creatSettingView();
        };

        LobbyController.prototype.destroySettingView = function () {
            return this.lobbyView.destroySettingView();
        };	
        LobbyController.prototype.createLuatchoiView = function () {
            return this.lobbyView.createLuatchoiView();
        };

        LobbyController.prototype.destroyLuatchoiView = function () {
            return this.lobbyView.destroyLuatchoiView();
        };
        LobbyController.prototype.createTaiApp = function () {
            return this.lobbyView.createTaiApp();
        };

        LobbyController.prototype.destroyTaiApp = function () {
            return this.lobbyView.destroyTaiApp();
        };		
        LobbyController.prototype.createHotlineView = function () {
            return this.lobbyView.createHotlineView();
        };

        LobbyController.prototype.destroyHotlineView = function () {
            return this.lobbyView.destroyHotlineView();
        };			

        LobbyController.prototype.pauseUpdateJackpot = function (isPause) {
            return this.LobbyJackpotView.pauseUpdateJackpot(isPause);
        };

        LobbyController.prototype.backToLobby = function () {
            return this.lobbyView.backToLobby();
        };

        
        LobbyController.prototype.openHotro = function () {
            return this.lobbyView.openHotro();
        };
        LobbyController.prototype.openWebsite = function () {
            return this.lobbyView.openWebsite();
        };

        LobbyController.prototype.showGroupLoginWithAnimation = function (isShow) {
            return this.lobbyView.showGroupLoginWithAnimation(isShow);
        };
