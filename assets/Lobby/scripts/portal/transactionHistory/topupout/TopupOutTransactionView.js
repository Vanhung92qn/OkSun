...
(function () {
    cc.TopupOutTransactionView = cc.Class({
        "extends": cc.Component,
        properties: {
            topupOutTransactionListView: cc.TopupOutTransactionListView,  
        ...
        onTopupHistoryResponse: function (response) {
            ...
            if (this.datas.length > 30) {
             ...
             this.topupOutTransactionListView.resetList();
                this.topupOutTransactionListView.initialize(list,this.start,this.end);
                }
        },
        ...
        openKhieuNai: function () {
         ...
         pageNextClicked: function () {
          ...
          // this.nodePagePrevious.active = true;
          // this.topupOutTransactionListView.resetList();
          // this.topupOutTransactionListView.initialize(this.datas, this.start, this.end);
        },
