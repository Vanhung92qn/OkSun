...
(function () {
    cc.BankOutTransactionListView = cc.Class({
        "extends": cc.ListView,
        properties: {
        ...
        initialize: function (messages, start, end) {
            ...
            for (var i = start; i < end; ++i) {
                ...
                item.getComponent(cc.BankOutTransactionItem).updateItem(this.messages[i], i);
            ...
            for (var i = 0; i < items.length; ++i) {
                ...
                if (isDown) {
                    ...
                    if (viewPos.y < -buffer && items[i].y + offset < 0) {
                        ...
                        var item = items[i].getComponent(cc.BankOutTransactionItem);
                    ...
                    if (viewPos.y > buffer && items[i].y - offset > -this.content.height) {
                        items[i].y  = (items[i].y - offset);
                        item = items[i].getComponent(cc.BankOutTransactionItem);
