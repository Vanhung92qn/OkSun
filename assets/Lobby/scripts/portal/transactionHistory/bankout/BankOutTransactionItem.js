...
(function () {
    cc.BankOutTransactionItem = cc.Class({
        ...
        updateItem: function(item, itemID) {
            ...
            if(item.RequestType == 2){
                ...
                switch (item.RequestType) {
                    case 1:
                        this.lbType.string = 'Internet Banking';
    				...
    				case 3:
                       ...
                       // this.lbType.node.color = cc.Color.RED;
                        break;
                    case 9:
                        this.lbType.string = 'Khuyến Mãi';
                       // this.lbType.node.color = cc.Color.RED;
                        break;
                }
                
                this.lbTranID.string = item.RequestID;

                if (item.StatusStr !== null) {
                    this.lbTranID.string = item.StatusStr;
                } else {
