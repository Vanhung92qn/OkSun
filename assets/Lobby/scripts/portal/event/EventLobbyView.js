...
(function () {
    cc.EventLobbyView = cc.Class({
        ...
        properties: {
            ...
            nodeLogoSonTinhThuyTinh: cc.Node,
            nodeLogoAnKheTraVang: cc.Node,
            nodeLogoKhoTangNguLong: cc.Node,
        ...
        reset: function () {
            ...
            this.nodeLogoSonTinhThuyTinh.active = false;
            this.nodeLogoAnKheTraVang.active = false;
            this.nodeLogoKhoTangNguLong.active = false;
        ...
        getNodeByGameId: function (gameId) {
            switch (gameId.toString()) {
                ...
                case cc.GameId.SONTINHTHUYTINH:
                    return this.nodeLogoSonTinhThuyTinh;
                case cc.GameId.ANKHETRAVANG:
                    return this.nodeLogoAnKheTraVang;
                case cc.GameId.KHOTANGNGULONG:
                    return this.nodeLogoKhoTangNguLong;
