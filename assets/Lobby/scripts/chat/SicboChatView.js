...
(function () {
    cc.SicboChatView = cc.Class({
        ...
        onEnable: function () {
			this.animation.play('openPopupchat');
...
//
        ...
        editingReturn: function () {
			...
			cc.PopupController.getInstance().showMessage('Bạn không đủ điều kiện để chat !');		
                //thong bao?
		...
		//	cc.TaiXiuSicboMainController.getInstance().destroySicboChatView();
            this.nodeChatView.active = !this.nodeChatView.active;
