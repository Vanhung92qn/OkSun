...
(function () {
    ...
    TaiXiuController = (function () {
        ...
        TaiXiuController.prototype.updateSessionHistory = function (gameHistory) {
            // Cache LUON, ke ca khi view chua mount -> mo lai UI giua phien van re-render duoc tu cache.
            this.gameHistory = gameHistory;
            if (this.taiXiuSessionHistoryView)
            return this.taiXiuSessionHistoryView.updateSessionHistory(gameHistory);
        };
        TaiXiuController.prototype.enabledotlight = function () {
            return this.taiXiuSessionHistoryView.enabledotlight();
        };
        TaiXiuController.prototype.disbledotlight = function () {
            return this.taiXiuSessionHistoryView.disbledotlight();
        };
        ...
        TaiXiuController.prototype.lightOnEvent = function () {
         ...
         TaiXiuController.prototype.closeChat = function () {
            return this.taiXiuButtonView.closeChat();
        };
