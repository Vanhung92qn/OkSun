    ...
    cc.TaiXiuSessionDetailView = cc.Class({
        ...
        getSessionDetailById: function (index) {
            ...
            this.nodeEffectTais.forEach(function (nodeEffectTai) {
                ...
                cc.tween(nodeEffectTai).repeatForever(cc.tween().sequence(cc.tween().to(0.2, { scale: 0.78 }, { easing: cc.easing.sineOut }),cc.tween().to(0.2, { scale: 0.82 }, { easing: cc.easing.sineOut }))).start();
            });
