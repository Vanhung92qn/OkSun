(function () {
    ...
    LodeController = (function () {
        ...
        LodeController.prototype.getLodeView = function () {
            return this.LodeView;
        };
        
        LodeController.prototype.setLodeBetView = function (view) {
            return (this.LodeBetView = view);
        };
        LodeController.prototype.getLodeBetView = function () {
            return this.LodeBetView;
        };
        LodeController.prototype.getCityID = function () {
            return this.LodeBetView.getCityID();
        };
        LodeController.prototype.getopenDate = function () {
            return this.LodeBetView.getopenDate();
        };
        ...
        LodeController.prototype.getChooseView = function () {
        ...
        LodeController.prototype.sendRequestOnHub = function (method, gateId, amount, betData,cityID,openDate) {
            if (this.LodeView)
                return this.LodeView.sendRequestOnHub(method, gateId, amount,betData, cityID,openDate);
        };
