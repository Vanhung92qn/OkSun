    ...
    cc.TaiXiuMd5InfoView = cc.Class({
        ...
        loadSoicau: function () {
            ...
            cc.director.getScheduler().schedule(function () {
                ...
                var arrsoicau = taiXiuMd5Config.SoiCau;
            ...
            switch (md5sessionInfo.CurrentState) {
                ...
                case cc.TaiXiuMd5State.RESULT: //15
                    ...
                    this.nodeBGTimer.active = true;
                     ...
                     if(md5sessionInfo.Ellapsed == 5){
                        let arrsoicau = taiXiuMd5Config.SoiCau;
                        //console.log("dsfgfdsffdsfdsfdsfdsfdsf");
                        let dicesum = md5sessionInfo.Result.Dice1 + md5sessionInfo.Result.Dice2 + md5sessionInfo.Result.Dice3;
                        let bets = 0;
                        if(dicesum < 11){
                            bets = 1;
                        }
                        let arrayadd = [];
                        arrayadd.SessionId = md5sessionInfo.SessionID;
                        arrayadd.FirstDice = md5sessionInfo.Result.Dice1;
                        arrayadd.SecondDice = md5sessionInfo.Result.Dice2;
                        arrayadd.ThirdDice = md5sessionInfo.Result.Dice3;
                        ...
                        taiXiuMd5Config.SoiCau = arrsoicau;
                    }
