...
(function () {
    ...
    XXPopupController = (function () {
        ...
        XXPopupController.prototype.createSettingView = function () {
            return this.xxPopupView.createSettingView();
        };

        XXPopupController.prototype.destroySettingView = function () {
            return this.xxPopupView.destroySettingView();
        };
        ...
        XXPopupController.prototype.createInviteUserView = function () {
            return this.xxPopupView.createInviteUserView();
        };
        XXPopupController.prototype.destroyInviteUserView = function () {
            return this.xxPopupView.destroyInviteUserView();
        };
        XXPopupController.prototype.setXXPopupBase = function (xxPopupBase) {
            return this.xxPopupBase = xxPopupBase;
        };
        XXPopupController.prototype.updateListDetailJackPot = function (list,time) {
            return this.xxPopupBase.updateListDetail(list,time);
        };
