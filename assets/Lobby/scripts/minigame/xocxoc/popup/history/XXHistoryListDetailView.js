...
(function () {
    cc.XXHistoryListDetailView = cc.Class({
        "extends": cc.ListView,
        properties: {
        ...
        initialize: function (messages) {
            ...
            for (var i = 0; i < spawnCountReal; ++i) {
                ...
                item.getComponent(cc.XXHistoryDetailItem).updateItem(this.messages[i], i);
            ...
            for (var i = 0; i < items.length; ++i) {
                ...
                if (isDown) {
                    ...
                    if (viewPos.y < -buffer && items[i].y + offset < 0) {
                        ...
                        var item = items[i].getComponent(cc.XXHistoryItem);
                    ...
                    if (viewPos.y > buffer && items[i].y - offset > -this.content.height) {
                        items[i].y = (items[i].y - offset);
                        item = items[i].getComponent(cc.XXHistoryItem);
