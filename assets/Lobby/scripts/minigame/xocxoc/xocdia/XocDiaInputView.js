...
(function () {
    cc.XXInputView = cc.Class({
        ...
        onLoad: function () {
            ...
            let point = 57.5;
            cc.tween(this.btnBet).to(0.1, { position: cc.v2((this.pointxbtnbet), 0) }).start();
            for (var i = 0; i < 10; i++) {
                cc.tween(this.btnChips[i].node).to(0.1, { position: cc.v2((point), 22) }).start();
                point = point + 145;
            }
            ...
            // this.minXs = [194, 235, 44, -375, -375,-172];
            // this.maxXs = [272, 315, 110,  -256, -318,-95];
            // this.minYs = [20, -195, -195, 20, -195, -195];
            // this.maxYs = [36, -185, -185, 36, -185, -185];

            // this.minXs = [194, -355, -145, 145, 42, 265]; 
            // this.maxXs = [272, -250, -42,  356, 143, 356];
            // this.minYs = [20, -132, -132, 20, -132, -132];
            // this.maxYs = [36, -113, -113, 36, -113, -113];

            // this.minXs = [-310, 265, 42, 150, -355, -145];  // 265,42,-145,-355 dung
            // this.maxXs = [-160, 356, 143,  290, -250, -42];
            // this.minYs = [20, -132, -132, 20, -132, -132];
            // this.maxYs = [36, -113, -113, 36, -113, -113];

            //   this.minXs = [150, 265, 42, -310, -355, -145];  // 265,42,-145,-355 dung
            //   this.maxXs = [290, 356, 143,  -160, -250, -42];
            //   this.minYs = [38, -132, -132, 38, -132, -132];
            //   this.maxYs = [91, -113, -113, 91, -113, -113];
            ...
            for (var i = 0; i < 6; i++) {
                ...
                this.minXs[i] = this.nodeSideBets[i].position.x - 50;
                this.maxXs[i] = this.nodeSideBets[i].position.x + 50;
                this.minYs[i] = this.nodeSideBets[i].position.y - 50;
                this.maxYs[i] = this.nodeSideBets[i].position.y;

                // console.log("pos node: " + this.nodeSideBets[i].position.x);
            }
            ...
            this.betVals = [100, 500, 1000, 5000, 10000, 50000, 100000, 500000];
