...
(function () {
    cc.Seven77BetlinesView = cc.Class({
        ...
        onEnable: function () {
            ...
            this.hoverButton(null, cc.Seven77SpinController.getInstance().getIndexButtonSelectLines());
        ...
        selectLineClicked: function (event, data) {
            ...
            if (this.buttonSelects.length > 0) {
                this.buttonSelects.forEach(bt => {
        ...
        hoverButton: function (event, data) {
            var i = parseInt(data.toString());
            this.buttonSelects.forEach((bt, index) => {
                bt.interactable = true;
                if (i == index) bt.interactable = false;
            });
            cc.Seven77SpinController.getInstance().setIndexButtonSelectLines(i);
        }
    });
}).call(this);
