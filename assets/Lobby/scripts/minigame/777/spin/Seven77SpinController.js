...
(function () {
    ...
    Seven77SpinController = (function () {
        ...
        Seven77SpinController.prototype.getIndexButtonSelectLines = function () {
            return this.seven77SpinView.indexButtonSelectLines;
        };

        Seven77SpinController.prototype.setIndexButtonSelectLines = function (index) {
            return this.seven77SpinView.indexButtonSelectLines = index;
        };
