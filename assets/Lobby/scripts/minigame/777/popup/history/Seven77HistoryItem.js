...
(function () {
    cc.Seven77HistoryItem = cc.Class({
        ...
        updateItem: function(item, itemID) {
            ...
            this.lbBet.string = cc.Tool.getInstance().formatNumber((item.TotalBetValue/item.TotalLines));
            var slotarray = item.SlotsData.split(",");
            this.lbLineWin.string = slotarray.length;
            /*
