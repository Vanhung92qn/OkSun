...
(function () {
    cc.SicboGroupUserListView = cc.Class({
        "extends": cc.ListView,
        properties: {},
        ...
        initialize: function (messages) {
            ...
            for (var i = 0; i < spawnCountReal; ++i) {
                ...
                item.getComponent(cc.SicboGroupItem).updateItem(this.messages[i], i);
            ...
            for (var i = 0; i < items.length; ++i) {
                ...
                if (isDown) {
                    ...
                    if (viewPos.y < -buffer && items[i].y + offset < 0) {
                        ...
                        var item = items[i].getComponent(cc.XXGroupItem);
                    ...
                    if (viewPos.y > buffer && items[i].y - offset > -this.content.height) {
                        items[i].y = (items[i].y - offset);
                        item = items[i].getComponent(cc.XXGroupItem);
