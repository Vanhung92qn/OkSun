...
(function () {
    ...
    BauCuaPopupController = (function () {
        ...
        BauCuaPopupController.prototype.createSettingView = function () {
            return this.baucuaPopupView.createSettingView();
        };

        BauCuaPopupController.prototype.destroySettingView = function () {
            return this.baucuaPopupView.destroySettingView();
        };
        ...
        BauCuaPopupController.prototype.destroyHistoryJackpotView = function () {
            return this.baucuaPopupView.destroyHistoryJackpotView();
        };
