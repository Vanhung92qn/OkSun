...
(function () {
    ...
    BauCuaController = (function () {
        ...
        BauCuaController.prototype.setBauCuaGraphView = function (infoView) {
            return this.BauCuaGraphView = infoView;
        };
        //playerLeave
        ...
        BauCuaController.prototype.jackpot = function (data) {
            return this.BauCua_InfoView.jackpot(data);
        };
        BauCuaController.prototype.setJackpot = function (money) {
            return this.BauCua_InfoView.setJackpot(money);
        };
        ...
        BauCuaController.prototype.getTime = function () {
            return this.BauCua_InfoView.getTime();
        };
        ...
        BauCuaController.prototype.checkBetAgain = function (isDisable) {
            return this.BauCua_BetView.checkBetAgain(isDisable);
        };
        ...
        BauCuaController.prototype.refundChips = function (sideWin) {
            this.BauCua_ChipsView.refundChips(sideWin);
        };
        ...
        BauCuaController.prototype.SoiCauonResponse = function (list) {
            return this.BauCuaGraphView.SoiCauonResponse(list);
        };
        ...
        //set Fade cac cua Sunwin
        BauCuaController.prototype.fadeSkeletonFinish = function () {
            return this.BauCua_BetView.fadeSkeletonFinish();
        };
