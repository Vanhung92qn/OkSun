...
(function () {
    cc.TQButtonView = cc.Class({
        ...
        properties: {
            ...
            skeletonCuoc100: sp.Skeleton,
            skeletonCuoc1k: sp.Skeleton,
            skeletonCuoc10k: sp.Skeleton,
        },

        onLoad: function () {
            cc.TQController.getInstance().setTQButtonView(this);

            this.betValues = [1000, 500, 5000, 10000, 30000, 50000, 100000];
        ...
        processUIByRoomId: function () {
            ...
            this.btn1000.node.getChildByName('default').active = true;
            this.btn10000.node.getChildByName('default').active = true;
            this.btn5000.node.getChildByName('default').active = true;
            this.btn1000.node.getChildByName('choose').active = false;
            this.btn10000.node.getChildByName('choose').active = false;
            this.btn5000.node.getChildByName('choose').active = false;

            switch (this.roomId) {
                case cc.TQRoomId.Room_1000:
                    //this.btn100.interactable = false;
                    this.btn1000.node.getChildByName('choose').active = true;
                    this.btn1000.node.getChildByName('default').active = false;
                    this.skeletonCuoc100.setAnimation(0,'active',true);
                    this.skeletonCuoc1k.setAnimation(0,'disable',true);
                    this.skeletonCuoc10k.setAnimation(0,'disable',true);
                    break;
                case cc.TQRoomId.Room_5000:
                    // this.sprite1000.spriteFrame = this.miniPokerImage.sfChips[0];
                    //this.btn1000.interactable = false;
                    this.btn5000.node.getChildByName('choose').active = true;
                    this.btn5000.node.getChildByName('default').active = false;
                    this.skeletonCuoc100.setAnimation(0,'disable',true);
                    this.skeletonCuoc1k.setAnimation(0,'active',true);
                    this.skeletonCuoc10k.setAnimation(0,'disable',true);
                    break;
                case cc.TQRoomId.Room_10000:
                    // this.sprite10000.spriteFrame = this.miniPokerImage.sfChips[0];
                    //this.btn10000.interactable = false;
                    this.btn10000.node.getChildByName('choose').active = true;
                    this.btn10000.node.getChildByName('default').active = false;
                    this.skeletonCuoc100.setAnimation(0,'disable',true);
                    this.skeletonCuoc1k.setAnimation(0,'disable',true);
                    this.skeletonCuoc10k.setAnimation(0,'active',true);
                    break;
            }
        ...
        setSkeletonSpin: function (anim, loop) {
            this.skeletonSpin.setAnimation(0, anim, loop);
            if (!loop) {
                this.skeletonSpin.setCompleteListener(function () {
