...
(function () {
    cc.DragonTigerResultEffectView = cc.Class({
        ...
        onLoad: function () {
            ...
            this.rongWinSkeleton = this.btnNodeRong.getChildByName("bgSide").getComponent(sp.Skeleton);
            this.rongHoSkeleton = this.btnNodeRong.getChildByName("bgSide").getComponent(sp.Skeleton);
        },
