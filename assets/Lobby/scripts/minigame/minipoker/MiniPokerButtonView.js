...
(function () {
    cc.MiniPokerButtonView = cc.Class({
        ...
        processUIByRoomId: function () {
            ...
            // this.btn5k.interactable = true;
            // this.btn10000.interactable = true;

            this.btn100.node.getChildByName('default').active = true;
            ...
            this.btn100.node.getChildByName('choose').active = false;
            ...
            switch (this.roomId) {
                case cc.MiniPokerRoomId.Room_100:
                    //this.btn100.interactable = false;
                    this.btn100.node.getChildByName('choose').active = true;
                    this.btn100.node.getChildByName('default').active = false;
                    break;
                case cc.MiniPokerRoomId.Room_1000:
                ...
                case cc.MiniPokerRoomId.Room_10000:
                    ...
                    break;
                case cc.MiniPokerRoomId.Room_5000:
                    // this.sprite10000.spriteFrame = this.miniPokerImage.sfChips[0];
                    //this.btn5k.interactable = false;
        ...
        startSpin: function () {
            ...
            var self = this;
            this.skSpin.setAnimation(0, 'GatCan', false);
