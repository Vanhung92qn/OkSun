                ...
                res.map(m => {
                    switch (m.M) {
                        ...
                        case cc.MethodHubOnName.GAME_HISTORY:
                            ...
                            cc.BacaratController.getInstance().setListHistory(m.A[0]);
                            cc.BacaratController.getInstance().initListSoiCau(m.A[0]);                           
                            cc.BacaratController.getInstance().initListCatCau(m.A[0]);                           
                            cc.BacaratController.getInstance().initListLichsu(m.A[0]);
                            if (cc.BacaratController.getInstance().getGraphView()) {
                                cc.BacaratController.getInstance().initListSoiCau2(m.A[0]);
                                cc.BacaratController.getInstance().initListCatCau2(m.A[0]);
                                cc.BacaratController.getInstance().updateThongKe(m.A[0]);
                            }
                            break;
