...
(function () {
    ...
    BacaratController = (function () {
        ...
        BacaratController.prototype.updatePlayerTotalBet = function (value) {
            return this.Bacarat_InfoView.updatePlayerTotalBet(value);
        };
        //HubOn summaryPlayer
        ...
        BacaratController.prototype.setListHistory = function (list) {
            return this.list_history = list;
        };
        BacaratController.prototype.getListHistory = function () {
        ...
        //SoiCauView
        BacaratController.prototype.setGraphView = function (soiCauView) {
            return this.Bacarat_GraphView = soiCauView;
        };
        BacaratController.prototype.getGraphView = function () {
            return this.Bacarat_GraphView;
        };
        //List Soi cau
        BacaratController.prototype.initListSoiCau2 = function (data) {
            return this.Bacarat_GraphView.initListSoiCau2(data);
        };
        //List CatCau
        BacaratController.prototype.initListCatCau2 = function (data) {
            return this.Bacarat_GraphView.initListCatCau2(data);
        };
        //List CatCau
        BacaratController.prototype.updateThongKe = function (data) {
            return this.Bacarat_GraphView.updateThongKe(data);
        };
        //Active graph
        ...
        BacaratController.prototype.initListCatCau = function (data) {
         ...
         //LichSuView
        BacaratController.prototype.setLichsuView = function (lichsuView) {
            return this.Bacarat_LichSu = lichsuView;
        };
        //List Lich Su
        BacaratController.prototype.initListLichsu = function (data) {
            return this.Bacarat_LichSu.initListLichsu(data);
        };
