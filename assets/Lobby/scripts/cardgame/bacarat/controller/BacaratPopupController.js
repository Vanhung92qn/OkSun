...
(function () {
    ...
    BacaratPopupController = (function () {
        ...
        BacaratPopupController.prototype.createSettingView = function () {
            return this.bacaratPopupView.createSettingView();
        };

        BacaratPopupController.prototype.destroySettingView = function () {
            return this.bacaratPopupView.destroySettingView();
        };
        ...
        BacaratPopupController.prototype.createHistorySoiCauView = function () {
            return this.bacaratPopupView.createHistorySoiCauView();
        };
        BacaratPopupController.prototype.destroyHistorySoiCauView = function () {
            return this.bacaratPopupView.destroyHistorySoiCauView();
        };
