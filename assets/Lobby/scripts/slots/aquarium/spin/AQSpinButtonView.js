    ...
    cc.AQSpinButtonView = cc.Class({
        ...
        activeButtonSpin: function (enable) {
            ...
            if (this.btnSelectBetLines !== undefined) {
                ...
                if (this.btnSpin.interactable = enable) {
					this.skeSpin.setAnimation(0, 'HOLD', true);
				} else {
					this.skeSpin.setAnimation(0, 'STOP PRESS', false);
				}
        ...
        activeButtonAutoSpin: function (enable) {
			...
			if (this.isAutoSpin = enable) {
				...
				this.skeAutoSpin.setAnimation(0, 'STOP IDLE', true);			
			} else {
