...
(function () {
    cc.FreeSpinView = cc.Class({
        ...
        activeFreeSpin: function (enable) {
            ...
            //bat cac node rieng cho freespin , cuop bien k dung
            // this.nodeForFreeSpins.forEach(function (nodeForFreeSpin) {
            //     nodeForFreeSpin.active = enable; 
            // });

            //tat cac node rieng cho freespin , cuop bien k dung
            ...
            if (enable) {
                ...
                this.spriteBGSlot.spriteFrame = this.sfFrameFreeSpin; // bg inside
                this.spriteBG.spriteFrame = this.sfBGSlotFreeSpin; // bg to
                this.bgVien.spriteFrame = this.sfBgVienFree;
        ...
        updateFreeSpinText: function (totalFreeSpin) {
            this.lbFreeSpinText.string = totalFreeSpin;
        },
