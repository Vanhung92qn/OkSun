...
(function () {
    cc.SpinColumnView = cc.Class({
        ...
        setIcon: function (indexIcon, iconId) {
            if (this.freeSpinController && this.freeSpinController.getStateFreeSpin()) {
                if (iconId >= 4 && iconId <= 6) {
                    ...
                    this.skeletonIcons[indexIcon].setAnimation(0, 'symbolFx', true);
                    this.skeletonIcons[indexIcon].setCompleteListener(
                        function () {
        ...
        checkActiveWild: function () {
            ...
            //             self.skeletonWild.setAnimation(0, 'appear', false);
            //             self.nodeWild.parent = self.nodeParentWildUpper;
            //             this.scheduler.schedule(function () {
            //                 self.skeletonWild.setAnimation(1, 'stay', true);
