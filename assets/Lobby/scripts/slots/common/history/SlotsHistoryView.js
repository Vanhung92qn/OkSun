        ...
        getHistoryList: function () {
            ...
            switch (gameId) {
                ...
                case cc.GameId.SONTINHTHUYTINH:
                    getHistoryCommand = new cc.GetSonTinhThuyTinhHistoryCommand;
                    getHistoryCommand.execute(this);
                    break;
                case cc.GameId.ANKHETRAVANG:
                    getHistoryCommand = new cc.GetAnKheTraVangHistoryCommand;
                    getHistoryCommand.execute(this);
                    break;
                case cc.GameId.KHOTANGNGULONG:
                    getHistoryCommand = new cc.GetKhoTangNguLongHistoryCommand;
                    getHistoryCommand.execute(this);
                    break;
