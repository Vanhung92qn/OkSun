        ...
        getJackpotList: function () {
            ...
            switch (gameId) {
                ...
                case cc.GameId.SONTINHTHUYTINH:
                    getJackpotCommand = new cc.GetSonTinhThuyTinhJackpotCommand;
                    getJackpotCommand.execute(this);
                    break;
                case cc.GameId.ANKHETRAVANG:
                    getJackpotCommand = new cc.GetAnKheTraVangJackpotCommand;
                    getJackpotCommand.execute(this);
                    break;
                case cc.GameId.KHOTANGNGULONG:
                    getJackpotCommand = new cc.GetKhoTangNguLongJackpotCommand;
                    getJackpotCommand.execute(this);
                    break;
