        ...
        getBigWinList: function () {
            ...
            switch (gameId) {
                ...
                case cc.GameId.SONTINHTHUYTINH:
                    getBigWinCommand = new cc.GetSonTinhThuyTinhBigWinCommand;
                    getBigWinCommand.execute(this);
                    break;
                case cc.GameId.ANKHETRAVANG:
                    getBigWinCommand = new cc.GetAnKheTraVangBigWinCommand;
                    getBigWinCommand.execute(this);
                    break;
                case cc.GameId.KHOTANGNGULONG:
                    getBigWinCommand = new cc.GetKhoTangNguLongBigWinCommand;
                    getBigWinCommand.execute(this);
                    break;
