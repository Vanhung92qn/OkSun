...
//
//            btnRooms: [cc.Button],
//			btnRoomChoiThu cc.Node,
//			btnRoomChoiThat cc.Node,
//            isShowRoom: true,
//            isShowLoading: false,
...
(function () {
    cc.RoomView = cc.Class({
        ...
        onLoad: function () {
            this.nodeLoadingloby.active = true;
            ...
            switch (this.gameId) {
                ...
                case cc.GameId.SONTINHTHUYTINH:
                    this.hubName = cc.HubName.SonTinhThuyTinhHub;
                    var sontinhNegotiateCommand = new cc.SonTinhThuyTinhNegotiateCommand;
                    sontinhNegotiateCommand.execute(this);
                    break;
                case cc.GameId.ANKHETRAVANG:
                    this.hubName = cc.HubName.AnKheTraVangHub;
                    var ankhetravangNegotiateCommand = new cc.AnKheTraVangNegotiateCommand;
                    ankhetravangNegotiateCommand.execute(this);
                    break;
                case cc.GameId.KHOTANGNGULONG:
                    this.hubName = cc.HubName.KhoTangNguLongHub;
                    var khotangngulongNegotiateCommand = new cc.KhoTangNguLongNegotiateCommand;
                    khotangngulongNegotiateCommand.execute(this);
                    break;
            ...
            if (cc.sys.isNative) {
                switch (this.gameId) {
                    ...
                    case cc.GameId.AQUARIUM:
                        ...
                        break;
                    case cc.GameId.SONTINHTHUYTINH:
                        cc.loader.releaseResDir('sontinhthuytinh/prefabs');
                        cc.loader.releaseResDir('sontinhthuytinh/images');
                        break;
                    case cc.GameId.ANKHETRAVANG:
                        cc.loader.releaseResDir('ankhetravang/prefabs');
                        cc.loader.releaseResDir('ankhetravang/images');
                        break;
                    case cc.GameId.KHOTANGNGULONG:
                        cc.loader.releaseResDir('khotangngulong/prefabs');
                        cc.loader.releaseResDir('khotangngulong/images');
                        break;
                    case cc.GameId.DRAGON_BALL:
            ...
            if (response.M !== undefined && response.M.length > 0) {
                ...
                switch (m.M) {
                    ...
                    case cc.MethodHubOnName.UPDATE_JACKPOT:
                        ...
                        if (this.isShowRoom) cc.JackpotController.getInstance().updateJackpot(jackpots);
                ...
                if (!this.isShowRoom) {
                    if (this.isShowLoading) {
                        if (!this.nodeLoading.active)
                            this.roomClicked(null, 2);
                    }
        ...
        roomClicked1: function (event, data) {
            var roomId = parseInt(data.toString());
            cc.RoomController.getInstance().setRoomId(roomId);
            if (roomId === 0) {
                if (this.btnRoomChoiThu && this.btnRoomChoiThat) {
                    this.btnRoomChoiThu.active = false;
                    this.btnRoomChoiThat.active = true;
                }
                this.sendRequestOnHub(cc.MethodHubName.PLAY_TRY);
                cc.RoomController.getInstance().setRoomId(1);
            } else {
                if (this.btnRoomChoiThu && this.btnRoomChoiThat) {
                    this.btnRoomChoiThu.active = true;
                    this.btnRoomChoiThat.active = false;
                }
                this.sendRequestOnHub(cc.MethodHubName.PLAY_NOW, roomId);
            }
        },
        ...
        roomChange: function (event, data) {
            var roomId = cc.RoomController.getInstance().getRoomId();
            ...
            console.log('read');
            this.roomClicked(null, roomId);
        },
        loadingProgressBar: function () {
            cc.tween(this.progressBar1)
                .to(2, { progress: 1 })
                .call(() => { this.nodeLoadingloby.active = false; })
                .start()
        }
    });
}).call(this);
