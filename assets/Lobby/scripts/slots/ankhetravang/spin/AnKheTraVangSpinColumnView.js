...
(function () {
    cc.AnKheTraVangSpinColumnView = cc.Class({
        ...
        setIcon: function(slotId, iconId) {
            if (iconId == 2) {
               ...
               // skeleton.setAnimation(0, iconId==3? 'Symbol_44' : 'animation', true);
            }
        },
        ...
        randomIcon2: function (indexIcon) {
            ...
            this.setIcon(parseInt(indexIcon.toString()), ran);
        },
        ...
        setData: function () {
            ...
            for (var i = 1; i <= 3; i++) {
                ...
                this.setIcon(i, parseInt(iconId) - 1);
            }
        },
