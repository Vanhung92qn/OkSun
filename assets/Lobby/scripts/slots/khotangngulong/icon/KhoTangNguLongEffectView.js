...
(function () {
    cc.KhoTangNguLongEffectView = cc.Class({
        ...
        onLoad:function(){
            this.animationFreeSpin = this.nodeFreeSpin.getComponent(cc.Animation);
        },
        ...
        playEffect: function (effectType, totalWin, tweenTime) {
            ...
            this.nodeFreeSpin.active = false;
            switch (effectType) {
                ...
                case cc.EffectType.NORMAL_WIN:
                    ...
                    break;
                case cc.EffectType.FREE_SPIN:
                    this.nodeFreeSpin.active = true;
                    this.animationFreeSpin.play('openWinFx');
                    this.particleJackpot.resetSystem();
                    break;
            }
