...
var slotsConfig = require('SonTinhThuyTinhConfig');
var gameMessage = require('GameMessage');


(function () {
    cc.KhoTangNguLongSpinView = cc.Class({
        extends: cc.SpinViewBase,
        properties: {
            spinColumnViews: [cc.KhoTangNguLongSpinColumnView],
            //anh nen cua phong
        ...
        updateNodeFreeSpin: function (num) {
            if (num > 0) {
                this.nodeFreeSpin.active = true;
                this.textFreeSpin.string = num;
            } else this.nodeFreeSpin.active = false;
        },
        ...
        updateBGRoomUI: function () {
            ...
            if (this.roomController.roomId == 3
                || this.roomController.roomId == 4) {
                if (this.roomController.roomId == 3)
                    this.nodeSpriteTry.active = true;
                else this.nodeSpriteTry.active = false;
                this.spriteBGRoom.spriteFrame = this.bg03;
            } else {
                this.nodeSpriteTry.active = false;
                this.spriteBGRoom.spriteFrame = this.bg12;
            }
        },
        ...
        stopSpinFinish: function () {
            ...
            if (this.indexStopFinish === 5) {
                ...
                // cc.log('finish ===> ' + JSON.stringify(this.spinResponse));
        ...
        playEffect: function (spinData) {
            ...
            this.scheduler.schedule(function () {
                ...
                if (cc.FreeSpinController.getInstance().getStateFreeSpin() === false && spinData.TotalFreeSpin > 0) {
                    // cc.EffectController.getInstance().playEffect(cc.EffectType.FREE_SPIN);
                    ...
                    // this.isAutoSpin = false;
                    // this.spinController.activeButtonAutoSpin(this.isAutoSpin);
                    this.updateNodeFreeSpin(spinData.TotalFreeSpin);
                    ...
                    this.scheduler.schedule(function () {
                        ...
                        self.updateNodeFreeSpin(spinData.TotalFreeSpin);
                        // cc.FreeSpinController.getInstance().updateFreeSpinText(spinData.TotalFreeSpin);
                    }, this, 0, 0, slotsConfig.TIME_WAIT_START_FREE_SPIN, slotsConfig.TIME_WAIT_START_FREE_SPIN, false);
                    ...
                    }, this, 0, 0, slotsConfig.TIME_WAIT_RESULT_FREE_SPIN, slotsConfig.TIME_WAIT_RESULT_FREE_SPIN, false);
