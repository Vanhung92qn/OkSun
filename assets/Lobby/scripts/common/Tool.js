  ...
  Tool = (function () {
    ...
    Tool.prototype.formatMoney = function (number, fix = 1) {
      if (number > 999999 || number < -999999) {
        return (
          this.numberRemoveDecimal(number / 1000000, fix).toLocaleString(
            "es-ES"
          ) + "M"
        );
      } else if (number > 999 || number < -999) {
        return (
          this.numberRemoveDecimal(number / 1000, fix).toLocaleString("es-ES") +
          "K"
        );
      } else {
    ...
    Tool.prototype.formatTotalUser = function (number) {
      let str = "" + number;
      // if (number >= 100 && number <= 999) {
      //     str = str.substring(0, 1) + "xx";
      // } else if (number >= 1000 && number <= 9999) {
      //     str = str.substring(0, 1) + ".xxx";
      // } else if (number >= 10000 && number <= 99999) {
      //     str = str.substring(0, 2) + ".xxx";
      // } else if (number >= 100000 && number <= 999999) {
      //     str = str.substring(0, 3) + ".xxx";
      // } else if (number >= 1000000 && number <= 9999999) {
      //     str = str.substring(0, 1) + "xxx.xxx";
      // }
    ...
    Tool.prototype.convertUTCTime123 = function (dateFormat) {
      var date = new Date(dateFormat + "Z");
    ...
    Tool.prototype.formatNumberV2 = function formatNumberV2(num) {
      if (num >= 1000000000) {
