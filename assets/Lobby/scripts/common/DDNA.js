        ...
        DDNA.prototype.getGameById = function (gameId) {
            switch (gameId.toString()) {
                ...
                case cc.GameId.SONTINHTHUYTINH:
                    return cc.DDNAGame.SONTINHTHUYTINH;
                case cc.GameId.ANKHETRAVANG:
                    return cc.DDNAGame.ANKHETRAVANG;
                case cc.GameId.KHOTANGNGULONG:
                    return cc.DDNAGame.KHOTANGNGULONG;
                ...
                case cc.GameId.TAI_XIU_LIVESTREAM:
                    return cc.DDNAGame.TAI_XIU_LIVESTREAM;
                case cc.GameId.XOC_DIA_LIVESTREAM:
                    return cc.DDNAGame.XOC_DIA_LIVESTREAM;
