...
(function () {
    cc.MethodHubOnName = cc.Enum({
        ...
        // taixiu livestream
        SESSION_INFO_LIVESTREAM: 'LivestreamsessionInfo', //enterLobby
        GAME_HISTORY_LIVESTREAM: 'LivestreamgameHistory', //enterLobby
        BET_OF_ACCOUNT_LIVESTREAM: 'LivestreambetOfAccount', //enterLobby
        BET_SUCCESS_LIVESTREAM: 'LivestreambetSuccess', //Bet
        WIN_RESULT_LIVESTREAM: 'LivestreamwinResult',
        CORD_ACCOUNT_INFO_LIVESTREAM: 'LivestreamcordAccountInfo', //thong tin du day của user
        EVENT_WINNER_RESULT_LIVESTREAM: 'LivestreameventWinnerResult', //ket qua khi trieu hoi duoc rong -> ban cho tat ca user
        SUMMON_DRAGON_AWARD_LIVESTREAM: 'LivestreamsummonDragonAward',		
        ...
        SLOT_RESULT: 'slotResult', //XocDia Tu Linh - mini-slot 4 dice 1..6
        JACKPOT_HIT: 'jackpotHit', //XocDia Tu Linh - nổ hũ
        JACKPOT_INFO: 'jackpotInfo', //XocDia Tu Linh - jackpot pool info on PlayNow
