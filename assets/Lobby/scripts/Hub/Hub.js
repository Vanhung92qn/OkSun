  ...
  Hub = (function () {
    ...
    Hub.prototype.connect = function (
      ...
      if (hubName && controller) {
        ...
        try {
          ...
          if (
            hubName === cc.HubName.DragonTigerHub ||
            hubName === cc.HubName.XocXocHub ||
            hubName === cc.HubName.XocDiaLivestreamHub ||
            hubName === cc.HubName.ChatHub ||
            hubName === cc.HubName.ThreeCardsHub ||
            hubName === cc.HubName.TexasPokerHub ||
            hubName === cc.HubName.TLMNHub ||
            hubName === cc.HubName.MBHub ||
            hubName === cc.HubName.BaccaratHub ||
            hubName === cc.HubName.TreasureHub ||
            hubName === cc.HubName.BauCuaHub ||
            hubName === cc.HubName.LodeHub ||
            hubName === cc.HubName.VietlotHub
          ) {
          ...
          var url =
            "wss://" +
            cc.Config.getInstance().getSubDomainByHub(hubName) +
            host +
            "/signalr/connect?" +
            ...
            "&tid=" +
            cc.Config.getInstance().getTID();

          if (cc.ServerConnector.getInstance().getToken()) {
            url +=
              "&access_token=" +
              encodeURIComponent(cc.ServerConnector.getInstance().getToken());
          }
          ...
          try {
            if (cc.sys.isNative) {
              this.netControl = new WebSocket(
                url,
                [],
                cc.url.raw("resources/cacert.pem")
              );
            } else {
    ...
    Hub.prototype.enterLobby = function () {
      ...
      switch (this.hubName) {
        ...
        case cc.HubName.XocDiaLivestreamHub:
        ...
        case cc.HubName.BauCuaHub:
          data.A = [
            cc.Config.getInstance().getDeviceType(),
            cc.LoginController.getInstance().getLoginResponse().RankID,
          ];
          break;
        case cc.HubName.XocDiaTLHub:
          data.A = [
            cc.Config.getInstance().getDeviceType(),
            cc.LoginController.getInstance().getLoginResponse().RankID,
            cc.RoomController.getInstance().getRoomId() || 0,
          ];
          break;
        default:
          break;
      ...
      switch (this.hubName) {
        ...
        case cc.HubName.MBHub:
          data.A = [
            roomId,
            1,
            cc.ServerConnector.getInstance().getLatitude(),
            cc.ServerConnector.getInstance().getLongitude(),
          ];
    ...
    Hub.prototype.spin = function (lines, roomId) {
      ...
      switch (this.hubName) {
        ...
        case cc.HubName.SonTinhThuyTinhHub:
        case cc.HubName.AnKheTraVangHub:
        case cc.HubName.KhoTangNguLongHub:
    ...
    Hub.prototype.playBonus = function (step, position) {
      //step 12 = choi nhanh
      var data = {
        ...
        switch (response.R) {
          case -10:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_10_INPUT_INVALID
            );
            break;
          case -11:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_11_LINES_INVALID
            );
            break;
          case -12:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_12_ROOM_NOT_EXIST
            );
            break;
          case -13:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_13_DEVICE_ID_NOT_EXIST
            );
            break;
          case -98:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_98_OTHER_DEVICE
            );
            break;
          case -99:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_99_EXCEPTION
            );
            break;

          case -211:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_211_ROOM_EXIST
            );
            break;
          case -214:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_214_ROOM_NOT_EXIST
            );
            break;
          case -231:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_231_PLAYER_NOT_IN_ROOM
            );
            break;
          case -232:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_232_TRANS_DATA_INVALID
            );
            break;
          case -233:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_233_ROOM_TYPE_NOT_EXIST
            );
            break;
          case -234:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_234_ROOM_OVER
            );
            break;
          case -235:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_235_ROOM_CANCELED
            );
            break;
          case -236:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_236_TOTAL_MONEY_NOT_EQUAL
            );
            break;

          case -504:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_504_NOT_ENOUGH_MONEY
            );
            break;

          case -999:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_999_UNDEFINED
            );
            break;

          case -1001:
            cc.PopupController.getInstance().showPopupRequireLogin(
              cc.HubError.ERROR_1001_NOT_AUTHENTICATE
            );
            break;
          case -1002:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_1002_PLAYER_NULL
            );
            break;
          case -1003:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_1003_DUPLICATE_SPIN
            );
            break;
          case -1004:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_1004_BLOCK_SPIN
            );
            break;
          case -1005:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_1005_BLOCK_PLAY_NOW
            );
            break;
          case -1006:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_1006_PLAY_BONUS
            );
            break;
          case -1007:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_1007_PLAY_FREE_SPIN
            );
            break;
          case -1008:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_1008_PLAY_X2
            );
            break;
          //VietLot
          case -600:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_600_SESSION_NOT_EXIST
            );
            break;
          case -601:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_601_MEGA_CODE_NOT_EXIST
            );
            break;
          case -602:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_602_SESSION_HAS_RESULT
            );
            break;
          case -603:
            cc.PopupController.getInstance().showMessageError(
              cc.HubError.ERROR_603_SESSION_HAS_REWARD
            );
            break;
        }
      }
